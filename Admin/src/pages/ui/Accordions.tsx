...
const Accordions = () => {
  return (
    <>
      <PageTitle pageTitle='Accordions' />
      <PageBreadcrumb
        breadCrumbItems={[
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14 mb-3">Click the accordions below to expand/collapse the accordion content.</p>
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14 mb-3">Add <code>.accordion-flush</code> to remove the default <code>background-color</code>, some borders, and some rounded corners to render accordions edge-to-edge with their parent container.</p>
              <Accordion flush defaultActiveKey="0">
                <Accordion.Item eventKey='1'>
                  <Accordion.Header as="h2">
                    Accordion Item #1
                  </Accordion.Header>
                  <Accordion.Body className="accordion-body">Placeholder content for this accordion, which is intended to demonstrate the
                    <code>.accordion-flush</code> class. This is the first item's accordion body.</Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey='2'>
                  <Accordion.Header as="h2">
                    Accordion Item #1
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14 mb-3">Omit the <code>data-bs-parent</code> attribute on each <code>.accordion-collapse</code> to make accordion items stay open when another item is opened.</p>
