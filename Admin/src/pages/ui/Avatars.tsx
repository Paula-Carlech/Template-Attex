        ...
        <Col xxl={6}>
          <Card>
            <Card.Body>
              ...
              <Row>
                <Col md={3}>
                  <Image src={avatar2} alt="avatar" className="avatar-xs rounded" fluid />
                  <p>
                    <code>.avatar-xs</code>
                  </p>
                  <Image src={avatar3} alt="avatar" className="avatar-sm rounded mt-2" fluid />                      <p className="mb-2 mb-sm-0">
                    <code>.avatar-sm</code>
                  </p>
                </Col>
                <Col md={3}>
                  <Image src={avatar4} alt="avatar" className="avatar-md rounded" fluid />
                  <p>
                    <code>.avatar-md</code>
                  </p>
                </Col>
                ...
                <Col md={3}>
                  <Image src={avatar5} alt="avatar" className="img-fluid avatar-lg rounded" />
                  <p>
                    <code>.avatar-lg</code>
                  </p>
                </Col>
                ...
                <Col md={3}>
                  <Image src={avatar6} alt="avatar" className="img-fluid avatar-xl rounded" />
                  <p className="mb-0">
                    <code>.avatar-xl</code>
                  </p>
                </Col>
        ...
        <Col xs={12}>
          <Card>
            <Card.Body>
              ...
              <Row>
                <Col sm={2}>
                  <Image src={img1} alt="avatar" className="rounded" width="200" fluid />
                  <p className="mb-0">
                    <code>.rounded</code>
                  </p>
                </Col>
                <Col sm={2} className="text-center">
                  <Image src={avatar6} alt="avatar" className="rounded" width="120" fluid />
                  <p className="mb-0">
                    <code>.rounded</code>
                  </p>
                </Col>
                <Col sm={2} className="text-center">
                  <Image src={avatar7} alt="avatar" className="rounded-circle" width="120" fluid />
                  <p className="mb-0">
                    <code>.rounded-circle</code>
                  </p>
                </Col>
                <Col sm={2}>
                  <Image src={img2} alt="avatar" className="img-thumbnail" width="200" fluid />
                  <p className="mb-0">
                    <code>.img-thumbnail</code>
                  </p>
                </Col>
                <Col sm={2}>
                  <Image src={avatar8} alt="avatar" className="rounded-circle img-thumbnail" width="120" fluid />
                  <p className="mb-0">
            ...
            <Card.Body>
              ...
              <Row>
                  ...
                  <div className="mt-lg-0 mt-3">
                    <div className="avatar-group">
                      ...
                      <div className="avatar-group-item">
                        <div className="avatar-xs">
                          <div
                            className="avatar-title rounded-circle text-bg-info">
                            A
                          </div>
                        </div>
                      </div>
                ...
                <Col lg={6}>
                  <div className="mt-lg-0 mt-3">
                    <div className="avatar-group">
                      <Link to="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Tosha">
                        <Image src={avatar1} alt="" className="rounded-circle avatar-sm" />
                      </Link>
                      <Link to="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Brain">
                        <Image src={avatar3} alt="" className="rounded-circle avatar-sm" />
                      </Link>
                      <Link to="#" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Hooker">
