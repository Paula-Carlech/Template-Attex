...
const Tabs = () => {
  const tabContents: TabContentItem[] = [
    ...
    },
    {
      ...
      text2: 'Setting-Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt.Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim.'
    },
  ];
  return (
    <>
      <PageTitle pageTitle='Tabs' />
      <PageBreadcrumb
        breadCrumbItems={[
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14 mb-3">Simple widget of tabbable panes of local content.</p>
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14 mb-3">Using class <code>.nav-justified</code>, you can force your <code>tab menu items</code> to use the full available width.</p>
              <Tab.Container defaultActiveKey="Profile">
