  ...
  return (
    <>
      ...
      <div className="input-group">
        ...
        <Button className="btn-outline-secondary" type="button">Button</Button>
      </div>
    </>
  )
}
    ...
    <>
      <Card>
        <Card.Body>
          ...
          <div className="mt-2">
            <Form.Check defaultChecked disabled className="form-check-inline"
              id="customCheck5"
              label="Check this custom checkbox"
            />
            <Form.Check disabled className="form-check-inline"
              id="customCheck6"
              label="Check this custom checkbox"
            />
          </div>
          ...
          {(colors || []).map((item, idx) => {
            return (
              <Form.Check
                ...
                className={`mb-2 form-checkbox-${item.variant}`}
                aria-label="option 1"
                defaultChecked
              />
            );
        ...
        <Card.Body>
          ...
          {(colors || []).map((item, idx) => {
            return (
              <Form.Check
                key={idx}
                label={`${item.name} Radio`}
                type="radio"
                id={`basic-radio-${idx}`}
                className={`mb-2 form-radio-${item.variant}`}
                aria-label="option 1"
                defaultChecked
              />
            );
    ...
    <>
      <Card>
        <Card.Body>
          ...
          <p className="text-muted fs-14">Here&apos;s a quick example to demonstrate Bootstrap&apos;s form styles. Keep reading for documentation on required classes, form layout, and more.</p>
    ...
    <>
      <Card>
        <Card.Body>
          ...
          <p className="text-muted fs-14">Be sure to use <code>.col-form-label-sm</code> or <code>.col-form-label-lg</code> to your <code>&lt;label&gt;</code>s or <code>&lt;legend&gt;</code>s to correctly follow the size of <code>.form-control-lg</code> and <code>.form-control-sm</code>.</p>
          ...
          <Form>
            ...
            <Row className="g-2">
              ...
              <Form.Group as={Col} md={4}
                className='mb-3' controlId="formGridState">
...
const BasicElements = () => {
  return (
    <>
      <PageTitle pageTitle='Form Elements' />
      <PageBreadcrumb
        breadCrumbItems={[
          { label: 'Forms', path: '/ui/forms/basic-elements' },
          { label: "Form Elements", path: "/ui/forms/basic-elements", active: true },
        ]}
        title={"Form Elements"}
      />
      <Row>
