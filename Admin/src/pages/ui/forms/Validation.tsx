  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14">Custom feedback styles apply custom colors, borders,
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14">If your form layout allows it, you can swap the
...
const Validation = () => {
  return (
    <>
      <PageTitle pageTitle='Form Validation' />
      <PageBreadcrumb
        breadCrumbItems={[
          { label: 'Forms', path: '/ui/forms/validation' },
          { label: "Form Validation", path: "/ui/forms/validation", active: true },
        ]}
