  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14">Push notifications to your visitors with a toast, a
          lightweight and easily customizable alert message.</p>

        <Row>
          <Col md={6}>
            <h5 className="mb-2">Basic</h5>
            <p className="text-muted fs-14">Toasts are as flexible as you need and
            ...
            <div className="p-3">
              <Toast onClose={hide} show={isOpen} autohide>
                <Toast.Header>
                  <img src={smLogo}
                    alt="brand-logo" height="16" className="me-1" />
                  <strong className="me-auto">Attex</strong>
          ...
          <Col md={6}>
            ...
            <p className="text-muted fs-14">Toasts are slightly translucent, too,
        ...
        <Row>
          <Col md={6} className="mt-4">
            ...
            <p className="text-muted fs-14">When you have multiple toasts, we
          ...
          <Col md={6} className="mt-4">
            ...
            <p className="text-muted fs-14">Place toasts with custom CSS as you
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14">Alternatively, you can also add additional controls
          and components to toasts.</p>

        <Toast className="align-items-center mb-4"
          show={isOpenCustom1}
          onClose={hideCustom1}
          delay={3000}
          autohide
        ...
        <Toast className="align-items-center text-white bg-primary border-0 mb-4"
          show={isOpenCustom2}
          onClose={hideCustom2}
          delay={6000}
          autohide
        ...
        <Toast className="mb-4"
          show={isOpenCustom3} onClose={hideCustom3} delay={8000} autohide>
          <Toast.Body>
            Hello, world! This is a toast message.
            <div className="mt-2 pt-2 border-top d-flex flex-wrap gap-1">
              <Button variant='primary' className="btn-sm">Take
                action</Button>
              <Button variant='secondary' className="btn-sm" onClick={hideCustom3}>Close</Button>
            </div>
          </Toast.Body>
        </Toast>
        ...
        >
          <Toast.Body className="text-white">
            Hello, world! This is a toast message.
            <div className="mt-2 pt-2 border-top d-flex flex-wrap gap-1">
              <Button variant='light' className="btn-sm">Take
                action</Button>
              <Button variant='secondary' className="btn-sm" onClick={hideCustom4} >Close</Button>
            </div>
          </Toast.Body>
        </Toast>
      </Card.Body>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14">Place toasts with custom CSS as you need them. The top
...
const Notifications = () => {
  return (
    <>
      ...
      <PageBreadcrumb
        breadCrumbItems={[
          { label: 'Base UI', path: '/ui/notifications' },
