...
import { Button, Card, Col, Row, Collapse as BootstrapCollapse } from 'react-bootstrap'
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14 mb-3">Bootstrap's collapse provides the way to toggle the visibility of any content or element. Please read the official <Link to="https://getbootstrap.com/docs/5.2/components/collapse/" target="_blank">Bootstrap</Link> documentation for a full list of options.
        </p>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14 mb-3">The collapse plugin also supports horizontal collapsing. Add the <code>.collapse-horizontal</code> modifier class to transition the <code>width</code> instead of <code>height</code> and set a <code>width</code> on the immediate child element.</p>
        <p>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="d-flex flex-wrap gap-1">
          <Link to="#" className="btn btn-primary" onClick={toggleFirst}>Toggle first element</Link>
          <Button variant='primary' type="button" onClick={toggleSecond}>Toggle second element</Button>
          <Button variant='primary' type="button" onClick={toggleBoth} >Toggle both elements</Button>
        </p>
        <Row>
          <Col>
...
const Collapse = () => {
  return (
    <>
      ...
      <PageBreadcrumb
        breadCrumbItems={[
          { label: 'Base UI', path: '/ui/collapse' },
          { label: "Collapse", path: "/ui/collapse", active: true },
        ]}
        title={"Collapse"}
      />
      <Row>
