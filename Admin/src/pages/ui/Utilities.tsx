...
const Utilities = () => {
  return (
    <>
      <PageTitle pageTitle='Utilities' />
      <PageBreadcrumb
        breadCrumbItems={[
          { label: 'Base UI', path: '/ui/utilities' },
          { label: "Tooltips", path: "/ui/utilities", active: true },
        ]}
        title={"Utilities"}
      />
      <Row>
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">Similar to the contextual text color classes, set the background of an element to any contextual class. Background
              ...
              {(colors || []).map((color, idx) => {
                return (
                  <div key={idx} className={`bg-${color.variant} ${(colors[idx].color) ? 'text-black' : 'text-white'}  p-2 mb-2`}>.bg-{color.variant}</div>
                )
              })
              }
            </Card.Body>
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">By adding a <code>.bg-gradient</code> class, a linear gradient is added as background image to the backgrounds. This
                gradient starts with a semi-transparent white which fades out to the bottom.</p>
              {(colors || []).slice(0, 8).map((color, idx) => {
                return (
                  <div key={idx} className={`bg-gradient bg-${color.variant} ${(colors[idx].color) ? 'text-black' : 'text-white'}  p-2 mb-2`}>.bg-{color.variant}.bg-gradient</div>
                )
              })}
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">Similar to the contextual text color classes, set the background of an element to any contextual class. Background utilities do not set <code>color</code>, so in some cases you’ll want to use <code>.text-*</code> <a href="https://getbootstrap.com/docs/5.3/utilities/colors/" target='_blank' rel='noreferrer'>color utilities</a>.</p>
              <Row>
                <Col xs={12}>
                  <div className="d-flex flex-column gap-2">
                    {(colors || []).slice(0, 8).map((color, idx) => {
                      return (
                        <div key={idx} className={`bg-${color.variant}-subtle p-2`}><code className={`text-${color.variant}-emphasis`}>.bg-{color.variant}-subtle</code></div>
                      )
                    })}
                  </div>
                </Col>
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">Color and background helpers combine the power of our <code>.text-*</code> utilities and <code>.bg-*</code> utilities in one class. Using our Sass <code>color-contrast()</code> function, we automatically determine a contrasting <code>color</code> for a particular <code>background-color</code>.</p>
              <div className="d-flex flex-column gap-2">
                {(colors || []).slice(0, 8).map((color, idx) => {
                  return (
                    <div key={idx} className={`text-bg-${color.variant} p-2`}>{color.variant.charAt(0).toUpperCase() + color.variant.slice(1)} with contrasting color (.text-bg-{color.variant})</div>
                  )
                })}
              </div>
            </Card.Body>
        ...
        <Col xl={12}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14"><code>background-color</code> utilities are generated with Sass using CSS variables. This
        ...
        <Col xl={12}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">Colorize text with color utilities. If you want to colorize links, you can use the <code>.link-*</code> helper classes which have <code>:hover</code>
                  ...
                  {(colors || []).slice(0, 7).map((color, idx) => {
                    return (
                      <React.Fragment key={idx}>
                        <p className={`text-${color.variant} ${(colors[idx].isBG) ? 'bg-dark' : ''}`}>.text-{color.variant}</p>
                        <p className={`text-${color.variant}-emphasis`}>.text-{color.variant}-emphasis</p>
                      </React.Fragment>
                    )
                  })}
                </Col>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">text color utilities are generated with Sass using CSS variables. This allows for real-time color
                  changes without compilation and dynamic alpha transparency changes.</p>
                {(opacities || []).map((opacity, idx) => {
                  return (
                    <div key={idx} className={`text-primary text-opacity-${opacity}`}>This is {opacity}% opacity primary text</div>
                  )
                })}
              </Card.Body>
            </Card>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">The <code>opacity</code> property sets the opacity level for an element. The opacity level describes the transparency
                ...
                <div className="d-flex flex-wrap gap-2">
                  {(opacities || []).map((opacity, idx) => {
                    return (
                      <div key={idx} className={`opacity-${opacity} p-2 bg-primary text-light fw-bold rounded`}>{opacity}%</div>
                    )
                  })}
                </div>
              </Card.Body>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Use border utilities to <b>add</b> an element’s borders. Choose from all borders or one at a time.</p>
                  ...
                  {(borders || []).map((border, idx) => {
                    return (
                      <div key={idx} className="text-center">
                        <div className={`border-${border.align} avatar-md bg-light bg-opacity-50`}></div>
                      </div>
                    )
                  })}
                </div>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Use border utilities to <b>remove</b> an element’s borders. Choose from all borders or one at a time.</p>
                <div className="d-flex align-items-start flex-wrap gap-4">
                  <div className="text-center">
                  ...
                  {(borders || []).map((border, idx) => {
                    return (
                      <div key={idx} className="text-center">
                        <div className={`border border-${border.align}-0 avatar-md bg-light bg-opacity-50`}></div>
                      </div>
                    )
                  })}
                </div>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Change the border color using utilities built on our theme colors.</p>

                <div className="d-flex align-items-start flex-wrap gap-2">
                  {(colors || []).slice(0, 8).map((color, idx) => {
                    return (
                      <div className="text-center" key={idx}>
                        <div className={`border border-${color.variant} ${(colors[idx].noBG) ? '' : 'bg-light'} avatar-md  bg-opacity-50`}></div>
                      </div>
                    )
                  })}
              ...
              <Card.Body>
                ...
                <div className="d-flex align-items-start flex-wrap gap-2">
                  ...
                  {(borders || []).map((border, idx) => {
                    return (
                      <div key={idx} className="text-center">
                        <div className={`border border-${border.size} bg-light avatar-md bg-opacity-50`}></div>
                      </div>
                    )
                  })}
                </div>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">choose from any of the <code>.border-opacity</code> utilities:</p>
                {(opacities || []).map((opacity, idx) => {
                  return (
                    <div key={idx} className={`border border-success p-2 mb-2 border-opacity-${opacity}`}>This is {opacity}% opacity success border</div>
                  )
                })}
              ...
              <Card.Body>
                ...
                <div className="d-flex align-items-start flex-wrap gap-2">
                  {(colors || []).slice(0, 8).map((color, idx) => {
                    return (
                      <div className="text-center" key={idx}>
                        <div className={`border border-${color.variant}-subtle ${(colors[idx].noBG) ? '' : 'bg-light'}  avatar-md bg-opacity-50`}></div>
                      </div>
                    )
                  })}
                </div>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Add classes to an element to easily round its corners.</p>

                <div className="d-flex align-items-start flex-wrap gap-2">
                  <img src={avatar2} className="avatar-lg rounded" alt="rounded" />
                  {(borders || []).map((round, idx) => {
                    return (
                      <img key={idx} src={avatar2} className={`avatar-lg rounded-${round.align}`} alt={`rounded-${round.align}`} />
                    )
                  })}
                  <img src={avatar2} className="avatar-lg rounded-circle" alt="rounded-circle" />
                  <img src={Img2} className="avatar-lg w-auto rounded-pill" alt="rounded-pill" />
                </div>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Use the scaling classes for larger or smaller rounded corners. Sizes range from <code>0</code> to <code>5</code>.</p>
                <div className="d-flex align-items-start flex-wrap gap-2">
                  <img src={avatar4} className="avatar-lg rounded-0" alt="rounded-0" />

                  {(data || []).map((border, idx) => {
                    return (
                      <img key={idx} src={avatar4} className={`avatar-lg rounded-${idx + 1}`} alt="rounded-0" />
                    )
                  })}
                </div>
              </Card.Body>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Use <code>user-select-all</code>, <code>user-select-auto</code>, or&nbsp;
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Bootstrap provides <code>.pe-none</code> and <code>.pe-auto</code> classes to prevent or add element interactions.</p>

                <p><Link to="#" className="pe-none" tabIndex={-1} aria-disabled="true">This link</Link> can not be clicked.</p>
                <p><Link to="#" className="pe-auto">This link</Link> can be clicked (this is default behavior).</p>
                <p className="pe-none">
                  <Link to="#" tabIndex={-1} aria-disabled="true" >This link</Link> can not be clicked because the&nbsp;
                  <code>pointer-events</code> property is inherited from its parent. However, <Link to="#" className="pe-auto">this
          ...
          <Col xl={12}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Adjust the <code>overflow</code> property on the fly with four default values and classes. These classes are not
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Arrange elements easily with the edge positioning utilities. The format is <code>{`{property}-{position}`}</code>.</p>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">In addition, you can also center the elements with the transform utility class <code>.translate-middle</code>.</p>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">By adding <code>.translate-middle-x</code> or <code>.translate-middle-y</code> classes, elements can be positioned only in horizontal or vertical direction.</p>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">While shadows on components are disabled by default in Bootstrap and can be enabled via&nbsp;
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Width utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for
                ...
                {(data || []).map((width, idx) => {
                  return (
                    <div key={idx} className={`w-${width} p-2 bg-light`}>Width {width}%</div>
                  )
                })}
              </Card.Body>
            </Card>
          ...
          <Col xl={6}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Height utilities are generated from the utility API in <code>_utilities.scss</code>. Includes support for&nbsp;
                  <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and <code>auto</code> by default. Modify
                  those values as you need to generate different utilities here.
                </p>
                ...
                <div className="d-flex flex-wrap gap-3 align-items-start" style={{ height: 255 }}>
                  {(data || []).map((height, idx) => {
                    return (
                      <div key={idx} className={`h-${height} p-2 bg-light`}>Height {height}%</div>
                    )
                  })}
                </div>
              </Card.Body>
          ...
          <Col xl={12}>
            <Card>
              <Card.Body>
                ...
                <p className="text-muted fs-14">Change the value of the <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/object-fit" target='_blank' rel='noreferrer'><code>object-fit</code> property</a> with our responsive <code>object-fit</code> utility classes. This property tells the content to fill the parent container in a variety of ways, such as preserving the aspect ratio or stretching to take up as much space as possible.</p>
                <div className="d-flex align-items-start flex-wrap gap-3 text-center">
                  {(objectTypes || []).map((type, idx) => {
                    return (
                      <div key={idx}>
                        <img src={Img1} className={`object-fit-${type} border rounded avatar-xl`} alt="..." />
                        <p className="mt-1 mb-0"><code className="user-select-all">.object-fit-{type}</code></p>
                      </div>
                    )
                  })}
                </div>
