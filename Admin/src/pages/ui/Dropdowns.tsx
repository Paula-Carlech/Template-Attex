  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">The best part is you can do this with any button variant, too:</p>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">
          Add <code>.dropdown-menu-animated</code>to a <code>.dropdown-menu</code> to have animated dropdown menu.</p>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Trigger dropdown menus above elements
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Trigger dropdown menus at the right of the elements by adding <code>.dropend</code> to the parent element.</p>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Add <code>.disabled</code> to items in the dropdown to <strong>style them as disabled</strong>.</p>
        ...
        <Dropdown as={ButtonGroup}>
          ...
          <Dropdown.Menu className="dropdown-menu">
            ...
            <Dropdown.Item disabled href="#" >Disabled link</Dropdown.Item>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Opt into darker dropdowns to match a dark navbar or custom style by adding <code>.dropdown-menu-dark</code> onto an existing <code>.dropdown-menu</code>. No changes are required to the dropdown items.</p>
        <Dropdown>
          <Dropdown.Toggle variant='secondary'>
            Dropdown button
          </Dropdown.Toggle>
          <Dropdown.Menu as="ul" variant='dark'>
            <li><Dropdown.Item active href="#">Action</Dropdown.Item></li>
            ...
            <li><Dropdown.Item href="#">Separated link</Dropdown.Item></li>
          </Dropdown.Menu>
        </Dropdown>
      </Card.Body>
    </Card>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to change the location of the dropdown.</p>
        <div className="d-flex">
          ...
          <Dropdown as={ButtonGroup}>
            ...
            <Dropdown.Toggle variant='secondary' className="dropdown-toggle-split">
              <span className="visually-hidden">Toggle Dropdown</span>
            </Dropdown.Toggle>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Place any freeform text within a dropdown menu with text and use spacing utilities. Note that you’ll likely need additional sizing styles to constrain the menu width.</p>
        ...
        {(colors || []).map((color, idx) => {
          return (
            <Dropdown key={idx} as={ButtonGroup} className="mb-2 me-1">
              ...
              <Dropdown.Toggle variant={color.color} className="dropdown-toggle-split">
                <span className="visually-hidden">Toggle Dropdown</span>
              </Dropdown.Toggle>
              <Dropdown.Menu>
                <Dropdown.Item href="#">Action</Dropdown.Item>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Trigger dropdown menus at the right of the elements by adding <code>.dropleft</code> to the parent element.</p>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Add <code>.active</code> to item in the dropdown to <strong>style them as active</strong>.</p>
        ...
        <Dropdown as={ButtonGroup}>
          ...
          <Dropdown.Menu>
            <Dropdown.Item href="#">Regular link</Dropdown.Item>
            <Dropdown.Item active href="#">Active link</Dropdown.Item>
            <Dropdown.Item href="#">Another link</Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
      </Card.Body>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Add a header to label sections of actions in any dropdown menu.</p>
        <Dropdown as={ButtonGroup}>
          <Dropdown.Toggle variant='secondary' >
            Header
          </Dropdown.Toggle>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Make the dropdown menu centered below the toggle with <code>.dropdown-center</code> on the parent element.</p>
        <div className="hstack gap-2">
          <Dropdown className="dropdown-center">
            ...
            <Dropdown.Menu as="ul">
              <li><Dropdown.Item href="#">Action</Dropdown.Item></li>
              <li><Dropdown.Item href="#">Action two</Dropdown.Item></li>
              <li><Dropdown.Item href="#">Action three</Dropdown.Item></li>
            </Dropdown.Menu>
          </Dropdown>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">By default, the dropdown menu is closed when clicking inside or outside the dropdown menu. You can use the <code>autoClose</code> option to change this behavior of the dropdown.</p>
        <div className="hstack gap-2">
          <Dropdown autoClose as={ButtonGroup} >
            ...
            <Dropdown.Menu as="ul">
              <li><Dropdown.Item href="#">Menu item</Dropdown.Item></li>
              <li><Dropdown.Item href="#">Menu item</Dropdown.Item></li>
              <li><Dropdown.Item href="#">Menu item</Dropdown.Item></li>
            </Dropdown.Menu>
          </Dropdown>
          ...
          <Dropdown autoClose="inside" as={ButtonGroup}>
            <Dropdown.Toggle variant='secondary' className="btn btn-secondary" type="button">
              Manual close
            </Dropdown.Toggle>
            <Dropdown.Menu as="ul">
              <li><Dropdown.Item href="#">Menu item</Dropdown.Item></li>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted font-14">Put a form within a dropdown menu, or make it into a dropdown menu, and use margin or padding utilities to give it the negative space you require.</p>
        <Dropdown>
          <Dropdown.Toggle variant='secondary'>
            Form
          </Dropdown.Toggle>
