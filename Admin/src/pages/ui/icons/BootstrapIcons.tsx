...
const BootstrapIcons = () => {
  return (
    <>
      <PageBreadcrumb
        breadCrumbItems={[
          { label: 'Icons', path: '/ui/icons/Bootstrap-icons' },
          { label: "Bootstrap Icons", path: "/ui/icons/Bootstrap-icons", active: true },
        ]}
        ...
        <Col>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted mb-2">Use class <code>&lt;i class=&quot;bi bi-123&quot;&gt;&lt;/i&gt;</code></p>
