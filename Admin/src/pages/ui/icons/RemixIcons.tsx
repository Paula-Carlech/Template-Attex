...
const RemixIcons = () => {
  ...
  return (
    <>
      <PageBreadcrumb
        breadCrumbItems={[
          { label: 'Icons', path: '/ui/icons/remix-icons' },
          { label: "Remix Icons", path: "/ui/icons/remix-icons", active: true },
        ]}
        title={"Remix Icons"}
      />
      <Row>
            ...
            return (
              <Card key={heading + idx}>
                <Card.Body>
                  ...
                  <p className="text-muted mb-2">Use <code>&lt;i class=&quot;ri-home-line&quot;&gt;&lt;/i&gt;</code> or <code>&lt;i class=&quot;ri-home-fill&quot;&gt;&lt;/i&gt;</code></p>
                  <Row className="icons-list-demo" id="icons">
                    {(heading !== 'Editor') ? (remixIconsList[0][heading].map((icon: string, idx: number) => {
                      return (
                    ...
                    ) : ((remixIconsList[0]['Editor'] || []).map((icon: string, idx: number) => {
                      return (
