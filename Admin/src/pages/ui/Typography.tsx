...
const Typography = () => {
  return (
    <>
      <PageTitle pageTitle='Typography' />
      <PageBreadcrumb
        breadCrumbItems={[
        ...
        <Col xs={12}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">Traditional heading elements are designed to work best in the meat of your page content. When you need a heading to stand out, consider using a display heading—a larger, slightly more opinionated heading style.</p>
        ...
        <Col xs={12}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">All HTML headings, <code>&lt;h1&gt;</code> through&nbsp;
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">Styling for common inline HTML5 elements.</p>
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">Available color variations.</p>
        ...
        <Col xl={4}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">A list of items in which the order does not explicitly matter.</p>
        ...
        <Col xl={4}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">A list of items in which the order does explicitly matter.</p>
        ...
        <Col xl={4}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14"><strong>This only applies to immediate children
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">For quoting blocks of content from another source within your document. Wrap <code>&lt;blockquote class="blockquote"&gt;</code> around any <abbr title="AttexText Markup Language">HTML</abbr> as the quote.</p>
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">Align terms and descriptions horizontally by using our grid system’s predefined classes (or semantic mixins). For longer terms, you can optionally add a <code>.text-truncate</code> class to truncate the text with an ellipsis.</p>
