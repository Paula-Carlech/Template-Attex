import { Button, Card, Col, OverlayProps, OverlayTrigger, Row, Tooltip } from 'react-bootstrap';
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14">Hover over the links below to see tooltips.</p>
    ...
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14">Elements with the <code>disabled</code> attribute
          ...
          keyboard-focusable using <code>tabindex={`"0"`}</code>, and override the <code>pointer-events</code> on the disabled element.</p>

        <div>
          <OverlayTrigger overlay={<Tooltip id="tooltip-disabled">Disabled Tooltip!</Tooltip>}>
            <span className="d-inline-block" >
              <Button variant='primary' className="pe-none" disabled>Disabled button</Button>
            </span>
          </OverlayTrigger>
        </div>
      </Card.Body>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14">Hover over the buttons below to see the four tooltips
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14">And with custom HTML added:</p>
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <p className="text-muted fs-14">We set a custom class with ex. <code>data-bs-custom-class="primary-tooltip"</code> to scope our background-color primary appearance and use
