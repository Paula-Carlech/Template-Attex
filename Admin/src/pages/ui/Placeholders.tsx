        ...
        <Row>
          <Col md={6}>
            <Card className="border shadow-none mb-md-0">
              ...
              <Card.Body>
                ...
                <Button variant='primary' as="a" href="#">Go somewhere</Button>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md={6}>
            <div className="card border shadow-none mb-0" aria-hidden="true">
              <svg className="bd-placeholder-img card-img-top" width="100%" height="180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#20c997" /></svg>
              <Card.Body>
...
const Placeholders = () => {
  return (
    <>
    <PageTitle pageTitle='Placeholders'/>
      <PageBreadcrumb
        breadCrumbItems={[
