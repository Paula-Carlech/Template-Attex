...
import { lineChartOpts, LineWithDataLabelOps, ZoomableTimeseriesOps, LineChartwithAnnotationOps, SyncingChartOps, SyncingChartOps2, GradientLineChartOps, MissingChartOps, DashedLineChartOps, SteplineChartOps, BrushChartOps, BrushChartOps2 } from './data'
...
const LineApex = () => {
  return (
    <>
      <PageTitle pageTitle='Apex Line Charts' />
      <PageBreadcrumb
        breadCrumbItems={[
          { label: 'Apex', path: '/ui/apex/line' },
          { label: "Line Charts", path: "/ui/apex/line", active: true },
        ]}
        title={"Line Charts"}
      />
      <Row>
