...
export const SimpleCandlestickOps: ApexOptions = {
  chart: {
    height: 400,
    type: "candlestick",
  },
...
export const ComboCandlestickOps: ApexOptions = {
  chart: {
    height: 240,
    type: "candlestick",
    toolbar: {
...
export const ComboBarCandlestickOps: ApexOptions = {
  chart: {
    height: 160,
    type: "bar",
    toolbar: {
...
export const CategoryXAxisOps: ApexOptions = {
  series: [
    {
      name: "candle",
      data: [
...
export const CandlestickwithLineOps: ApexOptions = {
  series: [
    {
      name: "Line",
      type: "line",
