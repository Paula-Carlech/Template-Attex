...
const Scrollspy = () => {
  return (
    <>
      <PageTitle pageTitle="Scrollspy" />
      <PageBreadcrumb
        breadCrumbItems={[
          { label: 'Extended UI', path: '/extended-ui/scrollspy' },
          { label: "Scrollspy", path: '/extended-ui/scrollspy', active: true },
        ]}
        title={"Scrollspy"}
      />
        ...
        <div className="col-12">
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">Scroll the area below the navbar and watch the active
        ...
        <div className="col-12">
          <Card>
            <Card.Body>
              ...
              <p className="text-muted fs-14">Scrollspy also works with nested <code>.nav</code>s.
      ...
      <Row>
        <div className="col-12">
          <Card>
            <Card.Body>
              <h4 className="header-title">Example with list-group</h4>
              <p className="text-muted fs-14">Scrollspy also works with nested <code>.nav</code>s.
                If a nested <code>.nav</code> is <code>.active</code>, its parents will also be
                <code>.active</code>. Scroll the area next to the navbar and watch the active
                class change.</p>
