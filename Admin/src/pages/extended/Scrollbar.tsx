...
const Scrollbar = () => {
  return (
    <>
      <PageTitle pageTitle="Scrollbar" />
      <PageBreadcrumb
        breadCrumbItems={[
          { label: 'Extended UI', path: '/extended-ui/scrollbar' },
          { label: "Scrollbar", path: '/extended-ui/scrollbar', active: true },
        ]}
        title={"Scrollbar"}
      />
        ...
        <Col xl={6}>
          <Card>
            <Card.Body className="pb-0">
              ...
              <p className="text-muted fs-14">Just use data attribute <code>data-simplebar</code>
        ...
        <Col xl={6}>
          <Card>
            <Card.Body className="pb-0">
              ...
              <p className="text-muted fs-14">Just use data attribute&nbsp;
      ...
      <Row>
        <Col xl={6}>
          <Card>
            ...
            <SimpleBar className="card-body py-0 mb-3" data-simplebar data-simplebar-lg style={{ maxHeight: 250 }}>
              SimpleBar does only one thing: replace the browser's default scrollbar
              with a custom CSS-styled one without losing performances.
              Unlike some popular plugins, SimpleBar doesn't mimic scroll with
              Javascript, causing janks and strange scrolling behaviours...
        ...
        <Col xl={6}>
          <Card>
            ...
            <SimpleBar className="card-body py-0 mb-3" data-simplebar data-simplebar-primary style={{ maxHeight: 250 }}>
              SimpleBar does only one thing: replace the browser's default scrollbar
              with a custom CSS-styled one without losing performances.
              Unlike some popular plugins, SimpleBar doesn't mimic scroll with
              Javascript, causing janks and strange scrolling behaviours...
